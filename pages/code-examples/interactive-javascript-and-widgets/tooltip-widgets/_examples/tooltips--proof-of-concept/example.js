(function() {
  ...
  AdgTooltip = (function() {
    ...
    AdgTooltip.prototype.initBalloon = function() {
      ...
      return this.$balloon.click((function(_this) {
        return function() {
          return _this.hide();
        };
      })(this));
    ...
    AdgTooltip.prototype.initElEvents = function() {
      this.$el.focusin((function(_this) {
        return function() {
          return _this.show();
        };
      })(this));
      this.$el.focusout((function(_this) {
        return function() {
          return _this.hide();
        };
      })(this));
      ...
      return this.$el.keyup((function(_this) {
        return function(e) {
          if (e.keyCode === 27) {
    ...
    AdgTooltip.prototype.initIconEvents = function() {
      this.$icon.mouseenter((function(_this) {
        return function() {
          return _this.show();
        };
      })(this));
      return this.$icon.mouseleave((function(_this) {
        return function() {
          if (!_this.$el.is(':focus')) {
            return _this.hide();
          }

...
[Table of divs using ARIA (example) ![Preview](_examples/table-of-divs-using-aria/_preview.png)](_examples/table-of-divs-using-aria)
...
[Table of divs with flexbox (example) ![Preview](_examples/table-of-divs-with-flexbox/_preview.png)](_examples/table-of-divs-with-flexbox)
...
[Invalid table of divs (example) ![Preview](_examples/invalid-table-of-divs/_preview.png)](_examples/invalid-table-of-divs)
...
[Fixed table of divs (example) ![Preview](_examples/fixed-table-of-divs/_preview.png)](_examples/fixed-table-of-divs)

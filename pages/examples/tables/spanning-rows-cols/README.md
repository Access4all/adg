...
position: 5
lead: "Spanning rows and columns is a standard HTML feature and exists for decades already. Be sure not to overuse them though, as they can be a bit tricky for screen readers, especially in complex data tables. And in general: keep your tables simple."
changed: "2018-04-13"
---
...
@example[Table spanning multiple rows and columns](table-spanning-multiple-rows-and-columns){.example}

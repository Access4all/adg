...
[Generally bad table, without headers (example) ![Preview](_examples/generally-bad-table-without-headers/_preview.png)](_examples/generally-bad-table-without-headers)
...
[Generally bad table, with only horizontal headers (example) ![Preview](_examples/generally-bad-table-with-only-horizontal-headers/_preview.png)](_examples/generally-bad-table-with-only-horizontal-headers)

...
[Table with block elements (example) ![Preview](_examples/table-with-block-elements/_preview.png)](_examples/table-with-block-elements)
...
[Table with block elements, fixed with ARIA (example) ![Preview](_examples/table-with-block-elements-fixed-with-aria/_preview.png)](_examples/table-with-block-elements-fixed-with-aria)

...
[HTML 5 headings outline (example) ![Preview](_examples/html-5-headings-outline/_preview.png)](_examples/html-5-headings-outline)
...
[HTML 5 headings outline with traditionally numbered headings (example) ![Preview](_examples/html-5-headings-outline-with-traditionally-numbered-headings/_preview.png)](_examples/html-5-headings-outline-with-traditionally-numbered-headings)
...
[HTML 5 headings outline with ARIA level fixes (example) ![Preview](_examples/html-5-headings-outline-with-aria-level-fixes/_preview.png)](_examples/html-5-headings-outline-with-aria-level-fixes)

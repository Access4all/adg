...
[Page with only one h1 on top of page (example) ![Preview](_examples/page-with-only-one-h1-on-top-of-page/_preview.png)](_examples/page-with-only-one-h1-on-top-of-page)
...
It might feel a bit awkward to have the main heading as both an `<h1>` and an `<h2>`. If you like, you can add a prefix to the heading in the `<main>` region and [hide it visually](/pages/examples/hiding-elements/visually), for example "Main content: ":
...
[Page with only one h1 on top of main content (example) ![Preview](_examples/page-with-only-one-h1-on-top-of-main-content/_preview.png)](_examples/page-with-only-one-h1-on-top-of-main-content)

...
[Grouped thematically related form controls (example) ![Preview](_examples/grouped-thematically-related-form-controls/_preview.png)](_examples/grouped-thematically-related-form-controls)
...
[Grouped and differentiated form controls (example) ![Preview](_examples/grouped-and-differentiated-form-controls/_preview.png)](_examples/grouped-and-differentiated-form-controls)
...
[Grouped radio buttons (example) ![Preview](_examples/grouped-radio-buttons/_preview.png)](_examples/grouped-radio-buttons)
...
[Grouped checkboxes (example) ![Preview](_examples/grouped-checkboxes/_preview.png)](_examples/grouped-checkboxes)
...
[Non related checkboxes (example) ![Preview](_examples/non-related-checkboxes/_preview.png)](_examples/non-related-checkboxes)
...
[Nested fieldset/legend structures (example) ![Preview](_examples/nested-fieldsetlegend-structures/_preview.png)](_examples/nested-fieldsetlegend-structures)
...
[Grouped form controls with too long legend (example) ![Preview](_examples/grouped-form-controls-with-too-long-legend/_preview.png)](_examples/grouped-form-controls-with-too-long-legend)
...
[Faked fieldset/legend using ARIA (example) ![Preview](_examples/faked-fieldsetlegend-using-aria/_preview.png)](_examples/faked-fieldsetlegend-using-aria)

---
layout: layout
title: "General good form example"
...
@example[Generally good form](generally-good-form){.example}
...
You may have noticed that NVDA doesn't activate focus mode when focusing a checkbox using the `Tab` key. As each and every other form control activates focus mode upon focus, this may feel irritating (if you haven't done this yet, go back and read [Screen readers' browse and focus modes](/knowledge/desktop-screen-readers/browse-focus-modes){.page}).

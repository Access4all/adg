...
[Form validation with messages next to controls (example) ![Preview](_examples/form-validation-with-messages-next-to-controls/_preview.png)](_examples/form-validation-with-messages-next-to-controls)
...
[Form validation with messages on top (example) ![Preview](_examples/form-validation-with-messages-on-top/_preview.png)](_examples/form-validation-with-messages-on-top)

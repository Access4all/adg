;(function () {
  ...
  AdgTooltipComplex = class AdgTooltipComplex {
    ...
    initIcon () {
      this.$icon = $(
        "<button class='adg-tooltip-complex-icon' aria-expanded='false'><span class='adg-visually-hidden'>Toggle tooltip</span><svg class='icon'><use xlink:href='#tooltip' /></svg></button>"
      )

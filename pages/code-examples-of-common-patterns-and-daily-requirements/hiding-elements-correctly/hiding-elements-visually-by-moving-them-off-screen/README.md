...
For example, this technique is useful to visually hide headings, as described here: [Adding visually hidden headings to complete a page's outline](/code-examples-of-common-patterns-and-daily-requirements/heading-outlines/adding-visually-hidden-headings-to-complete-a-pages-outline){.page}.

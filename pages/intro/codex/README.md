...
- Oder CodePen für rapid Prototyping zwischen Agentur, Kunde, und Accessibility-Tester! Siehe auch [How to use our code examples on CodePen.io](/examples/how-to-use-codepen-io). Ein Hinweis irgendwo, dass man am besten agil vorgeht (statt Wasserfall-artig) wäre auch gut.

ggf. muss unterkapitel "Treating disabled users differently" in [Differences Between JAWS and NVDA Screen Readers](/knowledge/desktop-screen-readers/differences-between-jaws-and-nvda-screen-readers) besser hier hinein?!
!(function (s) {
  ...
  function (e, t, s) {
    ...
    (c.get = function (e, t, s, n) {
      c.ajax({ url: e, success: t, error: s, dataType: n })
    }),
    (c.post = function (e, t, s, n) {
      c.ajax({ url: e, success: s, dataType: n, method: 'POST', data: t })
    }),
    (c.grep = function (e, t) {
  ...
  function (e, t, s) {
    ...
    t.a = function () {
          ...
          if (Oe || !Ve.a.matchesMediaQuery('max', 767)) {
            ...
            p
              ? (Ie && k.attr('aria-expanded', 'true'),
                a.isVisible()
                  ? (a.addClass('uniboxActive'), Fe())
                  : Ee() ||
                    (ze()
                      ? a.slideDown(U, function () {
                        a.addClass('uniboxActive'), Fe(), u()
                      })
                      : (a.css('display', 'block'),
        ...
        if (
          ...
          !(function () {
            for (
              ...
              Ve.a.inArray(e[t].replace(F, ''), m) == -1 &&
      ...
      function Ue () {
        return Ee()
          ? (Object(Ve.a)('#unibox-suggest-box-special').length === 0 && qe(),
      ...
      function _e () {
        if (ne) {
          ...
          ;(s && s.length !== 0) ||
            (qe(), (s = Object(Ve.a)('#unibox-special'))),
          (s.get()[0].scrollTop = 0)
      ...
      return {
        ...
        init: function (e, t) {
          ...
          (H = t.trackingCallbacks || {}),
          (D = t.placeholder),
          (G = t.instantVisualFeedback),
          (q = t.queryVisualizationHeadline),
  ...
  function (e, t, m) {
    ...
    var ee = m(0),
      x = {
        ...
        tracking: { providers: [], searchCallback: void 0, enhanced: !0 },
        callbacks: {
        ...
        voiceSearch: { enabled: !1, lang: 'en-US' },
        filters: {
          enabled: !1,
          position: 'left',
          label: 'Filter',
      ...
      v = function (l, i) {
        ...
        (this.trackSearchBoxFocus = function (e) {
          ...
          m({ url: c + b.searchBoxFocus, type: 'POST', data: s })
        }),
          ...
          a[s] !== n &&
              ((a[s] = n),
                ...
                ;(e.data = JSON.stringify(e.data)),
                  m({ url: c + b.searchBoxBulkChange, type: 'POST', data: e }),
                  (o[s] = void 0)
                }, 300)))
        }),
        ...
        (this.trackSearchBoxAbandon = function (e, t, s) {
          ...
          m({ url: c + b.searchBoxAbandon, type: 'POST', data: i })
        }),
        (this.trackShowSuggests = function (e, t, s, n, i) {
          ...
          m({ url: c + b.suggestShow, type: 'POST', data: a })
        }),
        ...
        (this.trackSerpShow = function (e, t, s, n, i, o) {
          ...
          m({ url: c + b.serpShow, type: 'POST', data: r })
        }),
        ...
        (this.trackFilterInteraction = function (e, t, s) {
          ...
          m({ url: c + b.filterInteraction, type: 'POST', data: i })
        })
      },
      w = {
      ...
      o = function (s, e) {
        var t =
          ...
          n =
            ...
            t +
            (!0 === e ? '' : window.location.hash)
        return { Page: document.title, Url: n }
      },
      r = function () {
      ...
      E = {
        ...
        replaceState: function (e, t) {
          if (i()) {
            var s = o(e, t)
            try {
              history.replaceState(s, s.Page, s.Url)
            } catch (e) {
              console.warn(e)
            }
          }
            ...
            ee.a.each(f.suggests, function (c, e, t) {
              ...
              var n =
                  ...
                  void 0 !== f.totalResultsPerContentGroup[c]
                    ...
                    : v
              !w && B && (n = f.suggests[c].length), (n = n || v)
              var u = Math.min(n, k)
              ...
              if (
                (ee.a.each(e, function (e, t) {
                  var s = C.buildSuggestItem(O !== null && S <= r, t, b)
                  o.find('ul').append(s), r++
                }),
                  (I += r),
                  e.length > 0 &&
                    (p.append(o),
                      j && D.highlightQueryTermsInResult(b),
                      O !== null &&
                      Object(ee.a)(
                        '.ss360-group-' +
                          s +
                ...
                l.on('click', function (e) {
                  ...
                  if ((j && D.highlightQueryTermsInResult(b), r < u)) {
                    var l = this
                    y.prefetchResults(
                      r,
                      c,
          ...
          if (t == 'FREE' || t == 'COLUMBO') {
            ...
            e.append(
              '<div><a href="https://sitesearch360.com" target="_blank"><img alt="Powered by Site Search 360" aria-label="Powered by Site Search 360" role="presentation" style="max-width:120px!important;float:right;position:absolute;top:0;right:5px;'
                ...
                .concat(D.getLogoSrc(s), '"></a></div>')
            )
          }
        })
      },
      Q = {
        getInitializationErrors: function (e, t) {
          var s = []
          return (
      ...
      u = function (e, t, s) {
        void 0 !== e &&
          (h(t, e.color), h(s, e.color), c(t, e.size), c(s, e.size))
      },
      f = function (e, t, s) {
        void 0 !== e &&
          (d(t, e.radius), d(s, e.radius), p(t, e.color), p(s, e.color))
      },
      h = function (e, t) {
        O(e, 'color', t)
      },
      ...
      d = function (e, t) {
        void 0 !== t && (O(e, 'border', '1px solid'), O(e, 'border-radius', t))
      },
      p = function (e, t) {
        O(e, 'border-color', t)
      },
      ...
      b = function (e, t) {
        O(e, 'background-color', t)
      },
      O = function (e, t, s) {
        void 0 !== s && e.css(t, s)
      },
      S = function (e, t, s, n, i) {
          ...
          var o,
            ...
            r =
              i === 'fullscreen' && e.attr('id') === 'ss360-query'
                ...
                : e.outerHeight()
          o = (r - (a = r - 18)) / 2
          var l = D.getBase64Magnifier(t.color || n)
          e.css(
            'background',
            ...
            !(function (e, t, s, n) {
              if (void 0 !== e) {
                ...
                for (
                  ...
                  S(Object(ee.a)(i[l]), e.icon, a, r, n)
                }
          ...
          try {
            !(function (e) {
              if (void 0 !== e) {
                ...
                g(t, e.padding),
                O(t, 'margin-top', e.distanceFromTop),
                void 0 !== e.text && h(t, e.text.color),
                void 0 !== e.background && b(t, e.background.color),
                void 0 !== e.border &&
                    (d(t, e.border.radius), p(t, e.border.color))
              }
            })(e.suggestions)
          } catch (e) {
            console.warn(e)
      ...
      C = 'webkitSpeechRecognition' in window,
      _ = function (s, t, n) {
        if (C) {
          var r = Object(ee.a)(
      ...
      I = {
        ...
        prefetchAndRender: function (i, o, a, r, e) {
          ...
          I.fetch(t, function (e) {
            var t = e.suggests[i.contentGroup]
            if (void 0 !== t) {
              var s = F.getSafeKey(i.contentGroup),
        ...
        handleBackPress: function (e, t, s, n, i, o) {
          ...
          if (r < d.find('.ss360-suggests:not(.ss360-hidden)').length) u()
            ...
            D.showLoadingAnimation()
            var h = r + 1 - d.find('.ss360-suggests').length,
              p = Math.ceil(h / i) + 1,
              g = { num: r + p * i, pageSize: p * i }
      ...
      A = { baseUrl: 'https://global.sitesearch360.com' },
      X = {
        ...
        buildSuggestionUrl: function (e, t, s, n, i, o, a, r) {
          if (!t) return ''
          var l = A.baseUrl + '/sites/suggest?site=' + e + '&limit=' + s
          return (
            n &&
      ...
      B = function (r, e, l, t) {
          ...
          M ||
            (r.html(''),
              r
                ...
                .append(O)
                .append(S)),
          void 0 !== h && (O.append(j), S.append(C))
          var e =
              u.toString().length +
              (Math.round(f) === f
                ? 0
        ...
        var P = function () {
          ...
          H = -1,
          D = function () {
            clearTimeout(H), (H = setTimeout(z, 600))
          },
          z = function () {
            clearTimeout(H),
            (H = -1),
    ...
    var R = function t (s, n, i) {
      ...
      L = function (d, u, p) {
        var g = function (n, e, t) {
            var s = 'ss360-filter-' + F.getSafeKey(n),
            ...
            if (
              ...
              o.find('.ss360-filter-btn').on('click', function (e) {
                e.preventDefault(), e.stopPropagation(), R(n, o, u)
              })
            } else if (d === 'left') {
              var l = function () {
                o
          ...
          c = function (s, n, i, o, e, t, a, r, l) {
            ...
            var h = new B(
              d,
              { min: i, max: o, step: e, unit: t, drawHistogram: l },
              r,
              function (e, t) {
                ;(u === e && f === t) ||
                  ((u = e),
      ...
      Z = function (t, e, s, n, i) {
        ...
        if (void 0 !== x) {
          ...
          j(),
          setTimeout(j, 200),
          Object(ee.a)(window).on('resize.ss360FilterResize', j)
        }
        if (
          (c.forEach(function (e) {
            e.append(r)
          ...
          var C = Object(ee.a)(
            '#ss360-filter-'.concat(F.getSafeKey(window.ss360ActiveGroup))
          )
          C.length > 0 && R(window.ss360ActiveGroup, C, h)
        }
        if (o === 'left') {
      ...
      P = function (O) {
        var S,
          ...
          t = e + 1,
          r = [],
          f = ee.a.readCookie('ss360-tracking') != '0'
        z.setTracking(f),
        O.tracking.enhanced &&
        ...
        var l = void 0,
          c = !1
        z.setSiteId(u)
        var T = D.getHiddenParts(O.layout.mobile, O.layout.desktop),
          i = function () {
            return new k(
              I,
              t,
          ...
          N = function (e) {
            ...
            Object(ee.a)('#ss360CloseLayerButton').click(j.closeLayer)
        ...
        (this.changeConfig = function (e, t) {
          ...
          (C = n()),
          e.indexOf('layout') !== -1 &&
                (T = D.getHiddenParts(O.layout.mobile, O.layout.desktop)),
        ...
        (this.closeLayer = function () {
          ...
          if (
            ...
            window.SS360Insights.trackSerpLeave(
              ...
              M,
              t.length,
              Object(ee.a)('#ss360-404-layer').length > 0 ? 'smart404' : C
            )
          }
          C === 'fullscreen' && c
            ? ((c = !1),
              D.hideFullscreenLayer(O.style.animationSpeed),
              E.removeSearchQueryParam(O.results.searchQueryParamName))
            : C === 'layover' &&
                (D.hideLayoverLayer(function () {
                  Object(ee.a)('#ss360-layer').fadeOut()
                }),
                  E.removeSearchQueryParam(O.results.searchQueryParamName),
                  O.filters.enabled && E.removeSearchQueryParam('ss360Filter')),
          O.callbacks.closeLayer != null && O.callbacks.closeLayer.call(j)
        }),
        (this.init = function () {
          var t = j
            ;(l = !0),
          ...
          C === 'fullscreen' &&
                ((O.searchBox.selector = '#ss360-query'),
                  (o = '#ss360-query'),
                  (O.results.embedConfig = { contentBlock: '#ss360-results' }),
          ...
          O.smart404 != null &&
                ...
                (L = U.checkAndHandle(O, j)),
          q.apply(O.style, o, O.searchBox.searchButton, C),
          !0 === O.voiceSearch.enabled &&
                Object(ee.a)(o)
                  .get()
                  .forEach(function (e) {
                    return new _(e, O.voiceSearch.lang, t.showResults)
                  })
          var i = Q.getInitializationErrors(o, L)
          if (
            ((l = i.length === 0)
              ? console.log(
                'SiteSearch360 ' + j.VERSION + ' initialized to ' + o
              )
              : (!0 === O.showErrors &&
                    (D.showError(i.join('<br/>')), D.hideLoadingAnimation()),
                console.error(
                  'SiteSearch360 ' +
                      j.VERSION +
        ...
        (this.recordTyping = z.initActionStartTime),
        ...
        (this.focus = function (e, t) {
          ...
          void 0 !== s && s && D.addDarkenInputLayer(d)
        }),
        (this.logQuery = z.logQuery),
        (this.followLink = function (e, t, s, n) {
          if (void 0 !== t) {
            if (
              (j.logQuery(e, 'select'),
                z.reportSerp(O.tracking, O.results.searchQueryParamName, e),
                s)
            ) {
              ...
              if (i != '') {
                var o = E.buildQueryDict()
                o[i] !== n.trim() &&
                    ((o[i] = n), delete o.ss360Filter, E.pushState(o, !0))
              }
              window.location.href = t
            }
          } else j.showResults(e)
        }),
        (this.prefetchResults = function (e, t, s, n, i, o) {
          var a = F.getSafeKey(t),
        ...
        (this.showResults = function (g, b, v, m, e, x, t, s) {
          ...
          if (
            (void 0 === n || typeof n !== 'function' || n.call(j, g, b, d)) &&
              g.trim().length !== 0
          ) {
            ;(g = g.trim()), D.showLoadingAnimation()
            var i =
                  C === 'embed' &&
                  void 0 !== S &&
                  void 0 !== S.url &&
              ...
              G.fetch(
                ...
                function (e) {
                  ...
                  if (((L = !1), O.callbacks.searchResult != null)) {
                    try {
                      O.callbacks.searchResult.call(j, e)
                    } catch (e) {
                      console.log(e)
                    }
                  } else {
                    ...
                    s.html(''),
                    S == null && O.results.showSearchBoxLayover && H(s, M),
                    (n =
                          S == null
                            ? Object(ee.a)(
                    ...
                    D.updateLayerByHiddenParts(T, n),
                    (t = new W(
                      O.layout.navigation,
                      e,
                      O.style.animationSpeed
                  ...
                  if (
                    ...
                    try {
                      O.callbacks.postSearch.call(j, e)
                    } catch (e) {
                      console.log(e)
                    }
                  }
        ...
        (this.showLoading = D.showLoadingAnimation),
        (this.hideLoading = D.hideLoadingAnimation),
        ...
        Object(ee.a)(document).ready(function () {
          ...
          ((o = ee.a).fn.unibox = function (i) {
            ...
            var e = this.map(function (e, t) {
              t = o(t)
              var s = o.extend(Q.copyObject(N), i)
          ...
          i.init(),
          s.style.defaultCss && H.renderDefaultStyles(s),
          (function (e, t, s, n, i) {
            var o = E.buildQueryDict()
            if (void 0 !== o.ss360SearchTerm && n) {
              try {
            ...
            if (void 0 !== o[e]) {
              var a = o[e] || ee.a.readCookie('ss360LastQuery')
              if (a != null) {
                i.getSearchResultType() === 'fullscreen' &&
                      (Object(ee.a)('#ss360-query').val(a),
                        Object(ee.a)('#ss360-search-console').css('top') !=
                        '0px' && i.showFullscreenLayer()),
                Object(ee.a)(s).val(a)
                var r = void 0
                if (t) {
                  try {
                    void 0 !== o.ss360Filter &&
                          (r = JSON.parse(o.ss360Filter))
                  } catch (e) {
                    console.warn(e)
                  }
                }
                i.showResults(a, void 0, r, !1, void 0, void 0, 'pageload')
              }
            }
          })(
